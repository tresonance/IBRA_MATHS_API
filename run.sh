...
# set image  name
my_manim_image="mahs_image"
# set container name
my_manim_container_name="my-maths-tle-container"

# Suject name in DISKE (where we must save this videos )
#Exemple "Maths" in /Volumes/DiskE/VIDEOS-1ere-Maths-mp4
diske_topic="Maths" 

#  variable GIT_MY_CHANEL_NAME, #Exemple: API_MATHS
...
then 
        ...
        #VOLUME_VIDEOS_PATH="/Volumes/DiskE/VIDEOS-1ere-Mathss-mp4/mp4_trigo"
        VOLUME_VIDEOS_PATH="/Volumes/DiskE/VIDEOS-${class_level}-${diske_topic}-mp4/dynamic"
        #MANIM_VIDEOS_BASE_PATH="$HOME/API_MATHS/1ere/Geometry/VIDEO-1ere-PRO-SCALAIRE-1-2-3-4/MANIM/media/videos"
...
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start building symbolik link  \n\
    #\n\
    ##################################################\n"
    ...
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Finish building symbolik link  \n\
    #\n\
    ##################################################\n"
...
then 
    ...
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] End building symbolik with SFE_SFML_IMGUI_LIBS generated library \n\
    #\n\
    ##################################################\n"
...
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start running make re command \n\
    #\n\
    ##################################################\n"
    echo " make re"
    echo
    ...
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Finish running make re command \n\
    #\n\
    ##################################################\n"
elif [[ "$1" == "clean" ]]
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start cleaning all objects files \n\
    #\n\
    ##################################################\n"
    ...
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Finish cleaning all objects files \n\
    #\n\
    ##################################################\n"
elif [[ "$1" == "makec" ]]
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start running \"make clean && make fclean && make re\" command \n\
    #\n\
    ##################################################\n"
    ...
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Finish running \"make clean && make fclean && make re\" command \n\
    #\n\
    ##################################################\n"
elif [[ "$1" == *.py ]]
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start building manim Scene image from python file \n\
    #\n\\t\t You must chck the result inside media directory \n
    #
    ##################################################\n"
  
    # ............... Remove unexpected directory .............
    # $(rm -rf ONLY_BOARD_SYMLINK/ONLY_BOARD_SYMLINK > /dev/null 2>&1)
