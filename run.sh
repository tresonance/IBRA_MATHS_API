...
then 
    echo -e "#####################################################################\n
    #\n\
    #\t\t [API MATHS] Start building symbolik with SFE_SFML_IMGUI_LIBS generated library \n\
    #\n\
    ##################################################\n"
...
then 
    ...
    #\n\
    ##################################################\n"
    echo " make re :[Please wait while files are been compiled ... ]"
    echo
...
then 
    ...
    echo
    echo -e "\n${ONWHITE} ${ONCYAN}......... Program MATHS starts running [Please wait ...] ....... ${RESET}\n"
...
case "$1" in
    "down" | "save" | "build" | "symol" | "symlink_ol" | "symlib" | "symlib_ol" |  "make" | "clean" | "makec")
        echo "Valid option: $1"
        ;;
*)
